"""Train LINC on TSP100 with the default paper configuration."""
...
from TSPTrainer import TSPTrainer as Trainer  # noqa: E402
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train the LINC TSP100 model.")
    parser.add_argument("--run-name", default="linc_tsp_n100")
    parser.add_argument("--problem-size", type=int, default=100)
    parser.add_argument("--epochs", type=int, default=330)
    ...
    parser.add_argument("--warm-start-checkpoint", default="models/PolyNet/n100/checkpoint-200.pt")
...
def build_params(args):
    ...
    trainer_params = {
        ...
        "model_load": {"enable": False} if args.no_warm_start else _parse_checkpoint(args.warm_start_checkpoint, 200),
