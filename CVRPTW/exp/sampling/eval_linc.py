"""LINC CVRPTW sampling evaluation."""
...
from LINC.CVRPTWTester import CVRPTWTester as Tester
...
def main():
    ...
    parser.add_argument("--checkpoint", default="models/LINC_env_scratch/n100")
    parser.add_argument("--epoch", type=int, default=11885)
    ...
    # Override eval_type from CLI
    _eval_type_override = args.eval_type
    if _eval_type_override in ("greedy", "argmax"):
        _eval_type_override = "argmax"
    elif _eval_type_override in ("sampling", "softmax"):
        _eval_type_override = "softmax"
    ...
    model_params = _checkpoint_model_params(ckpt_full_name, {
        ...
        "gated_attention_init_bias": 2.0, "alpha_attn_gate": 1.0,
        ...
        "candidate_rollout_chunk_size": 64, "use_decoder_checkpointing": False,
        "candidate_scorer_type": "quotient_lite",
        "quotient_lite_hidden_dim": 128, "quotient_scorer_activation": "gelu",
        "capture_candidate_aux": False, "candidate_feature_hidden_dim": 0,
    })

    if _eval_type_override:
        model_params["eval_type"] = _eval_type_override
