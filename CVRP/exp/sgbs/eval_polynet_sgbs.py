...
_sgbs_impl = os.path.join(os.path.dirname(__file__), "polynet_sgbs_impl.py")

def main():
    parser = argparse.ArgumentParser()
    add_dataset_args(parser, default="kool100")
    parser.add_argument("--checkpoint", default="models/PolyNet/n100/checkpoint-300.pt")
