...
def main():
    ...
    parser.add_argument("--epoch", type=int, default=1430)
    ...
    from LINC.CVRPTester import CVRPTester as Tester
    ...
    eval_type = "argmax" if getattr(args, "eval_type", "sampling") == "greedy" else "softmax"
    tester = Tester(
        ...
        model_params={
            ...
            "selected_candidate_feature_names": ["travel_dist_norm", "demand_ratio", "dist_to_depot_norm", "depot_angle_diff_norm"],
            ...
            "relative_candidate_feature_names": ["travel_dist_norm", "demand_ratio", "load_after_ratio", "dist_to_depot_norm"],
            "quotient_lite_hidden_dim": 64, "quotient_scorer_activation": "gelu",
